 ...
 */
export type AchievementChecker<TMove = unknown> = (
  context: AchievementContext<TMove>
) => boolean;
...
// =============================================================================
// Challenge Definition (Main Type)
// =============================================================================
...
export interface ChallengeDefinition<
  TEngine extends GameEngine<GameState, unknown, Record<string, unknown>, unknown>
> {
  /** Unique challenge identifier */
  ...
  readonly validateReplay?: (
    replay: GameReplay<MoveOf<TEngine>>
 ...
 */
export type ChallengeMap = Readonly<
  Record<string, ChallengeDefinition<GameEngine<GameState, unknown, Record<string, unknown>, unknown>>>
>;
...
export type StateOfChallenge<C> = C extends ChallengeDefinition<infer E>
  ? StateOf<E>
  : never;

/** Extract move type from challenge */
export type MoveOfChallenge<C> = C extends ChallengeDefinition<infer E>
  ? MoveOf<E>
  : never;

/** Extract board type from challenge */
export type BoardOfChallenge<C> = C extends ChallengeDefinition<infer E>
  ? BoardOf<E>
  : never;

/** Create typed challenge from engine */
export type ChallengeFor<E extends GameEngine<GameState, unknown, Record<string, unknown>, unknown>> =
  ChallengeDefinition<E>;
