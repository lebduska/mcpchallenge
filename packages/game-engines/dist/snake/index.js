...
function randomPosition(gridSize, exclude) {
...
function createInitialSnake(gridSize, length) {
...
function createSnakeEngine() {
    return {
        ...
        // -------------------------------------------------------------------------
        newGame(options = {}) {
            const { gridSize = DEFAULT_GRID_SIZE, initialLength = DEFAULT_INITIAL_LENGTH, } = options;
