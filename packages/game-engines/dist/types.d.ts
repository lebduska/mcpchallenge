...
export interface GameEngine<TState extends GameState, TMove, TOptions = Record<string, unknown>> {
    /** Engine metadata */
 ...
 */
export declare function createBaseState(gameId?: string): Pick<GameState, 'gameId' | 'status' | 'turn' | 'moveCount'>;
